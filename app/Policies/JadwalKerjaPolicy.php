...
{
    /** Super Admin & Reseller bisa lihat semua; Teknisi cuma yang dia jadi anggota tim-nya. */
    public function view(Admin $admin, JadwalKerja $jadwal): bool
    {
        if ($admin->peran === PeranAdminEnum::SUPER_ADMIN || $admin->peran === PeranAdminEnum::RESELLER) {
            return true;
        }
